    ...
    return BaseController.extend("com.davide.myapp.controller.List", {
        ...
        handlePopoverPress: function (oEvent) {
            var oButton = oEvent.getSource(),
                oView = this.getView();
            var oItem = oButton.getBindingContext("car").getObject();
        ...
        scelta1: function (oEvent) {
            this.byId("myPopover").close();
            MessageToast.show("Hai scelto questa macchina");
            var selected = this.getView().getModel("detail").oData;
            var list = this.getView().getModel("car").oData.car
